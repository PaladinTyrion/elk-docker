...
# kafka mount dir
echo "10.10.10.1:/data2/${local_ip}.kafka /data0/kafka nfs auto,soft,bg,intr,rw,rsize=262144,wsize=262144 0 0" >> /etc/fstab
# elk mount dir
...
echo "10.10.10.1:/data2/${local_ip}.elk/logstash /data0/elk/logstash nfs auto,soft,bg,intr,rw,rsize=262144,wsize=262144 0 0" >> /etc/fstab
